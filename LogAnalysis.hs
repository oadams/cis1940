...
parseMessage msg
  | msgType == "E" = LogMessage (Error (read (words msg !! 1) :: Int)) (read (words msg !! 2) :: Int) (unwords $ drop 3 $ words msg) 
  | msgType == "W" = LogMessage Warning (read (words msg !! 1) :: Int) (unwords $ drop 2 $ words msg)
  | msgType == "I" = LogMessage Info (read (words msg !! 1) :: Int) (unwords $ drop 2 $ words msg)
  | otherwise = Unknown msg
  where msgType = head $ words msg
